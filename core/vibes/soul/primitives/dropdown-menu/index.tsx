          ...
          {items.map((item, index) => {
            ...
            return (
              <DropdownMenuPrimitive.Item
                ...
                className={clsx(
                  'data-disabled:bg-contrast-100/50 data-disabled:text-contrast-300/95 cursor-pointer rounded-lg bg-[var(--dropdown-menu-item-background,transparent)] px-3 py-2 font-[family-name:var(--dropdown-menu-item-font-family,var(--font-family-body))] text-sm font-medium outline-hidden transition-colors data-disabled:cursor-not-allowed',
                  {
                    default:
