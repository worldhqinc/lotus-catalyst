...
export function ButtonLink({
  ...
  return (
    <Link
      {...props}
      className={clsx(
        'relative z-0 inline-flex h-fit items-center justify-center overflow-hidden border text-center font-[family-name:var(--button-font-family,var(--font-family-body))] leading-normal font-medium transition-all duration-200 select-none',
        {
          primary:
            'hover:bg-primary-highlight focus-visible:bg-primary-highlight disabled:border-disabled disabled:bg-disabled border-[var(--button-primary-border,hsl(var(--primary)))] bg-[var(--button-primary-background,hsl(var(--primary)))] text-[var(--button-primary-text,hsl(var(--background)))] focus-visible:ring-0 focus-visible:ring-offset-0',
          secondary:
            'hover:text-foreground focus-visible:text-foreground disabled:border-disabled-secondary disabled:bg-disabled-secondary border-[var(--button-secondary-border,hsl(var(--foreground)))] bg-[var(--button-secondary-background,hsl(var(--foreground)))] text-[var(--button-secondary-text,hsl(var(--background)))] hover:bg-[var(--button-secondary-background-hover,hsl(var(--background)))] focus-visible:ring-0 focus-visible:ring-offset-0 disabled:text-white',
          tertiary:
            'focus-visible:bg-contrast-100 disabled:border-contrast-100 disabled:text-contrast-200 focus-visible:text-foreground border-[var(--button-tertiary-border,hsl(var(--contrast-200)))] bg-[var(--button-tertiary-background,hsl(var(--background)))] text-[var(--button-tertiary-text,hsl(var(--foreground)))] hover:bg-[var(--button-tertiary-background-hover,hsl(var(--contrast-100)))] focus-visible:ring-0 focus-visible:ring-offset-0',
          ghost:
            'hover:border-contrast-100 focus-visible:ring-primary disabled:text-contrast-200 border-[var(--button-ghost-border,transparent)] bg-[var(--button-ghost-background,transparent)] text-[var(--button-ghost-text,hsl(var(--foreground)))] hover:bg-[var(--button-ghost-background-hover,hsl(var(--foreground)/5%))] focus-visible:ring-0 focus-visible:ring-offset-0 disabled:border-transparent',
