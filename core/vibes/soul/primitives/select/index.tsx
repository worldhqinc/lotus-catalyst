  ...
  return (
    ...
    >
      <SelectPrimitive.Trigger
        aria-label={label}
        className={clsx(
          'text-contrast-500 focus-visible:border-primary flex h-fit max-h-[46px] w-full items-center justify-between gap-3 border p-3 text-sm font-medium transition-colors select-none focus-visible:ring-0 focus-visible:ring-offset-0 focus-visible:outline-hidden',
      ...
      <SelectPrimitive.Portal>
        <SelectPrimitive.Content
          className={clsx(
            'data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 z-50 max-h-80 overflow-y-auto rounded-xl p-2 shadow-xl ring-1 @4xl:rounded-3xl @4xl:p-4',
            {
