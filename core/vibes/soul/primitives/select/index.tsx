  ...
  return (
    ...
    >
      <SelectPrimitive.Trigger
        aria-label={label}
        className={clsx(
          'text-contrast-500 focus-visible:border-primary flex h-fit max-h-[50px] w-full items-center justify-between gap-3 border p-3 text-sm font-medium transition-colors select-none focus-visible:ring-0 focus-visible:ring-offset-0 focus-visible:outline-hidden',
