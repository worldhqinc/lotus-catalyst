...
export function InlineEmailForm({
  ...
  return (
    ...
    >
      <div
        className={clsx(
          'bg-background focus-within:border-primary relative border-b text-base transition-colors duration-200 focus:outline-hidden focus-visible:shadow-none focus-visible:ring-0 focus-visible:ring-offset-0 focus-visible:outline-none',
      ...
      >
        <input
          ...
          className={clsx(
            'placeholder-contrast-gray-500 text-foreground placeholder:font-heading h-14 w-full bg-transparent pr-16 placeholder:font-normal focus:outline-hidden focus-visible:shadow-none focus-visible:ring-0 focus-visible:ring-offset-0 focus-visible:outline-hidden focus-visible:outline-none @4xl:placeholder:text-xl',
            inputClassName,
          )}
          data-1p-ignore
          key={fields.email.id}
