...
export function HeroSection({
  ...
  return (
    <SectionLayout className="bg-surface-image relative isolate flex aspect-[3/4] w-full items-center overflow-hidden py-20 text-center lg:aspect-video xl:max-h-[calc(100svh-101px)] max-lg:landscape:aspect-video">
      {mediaElement}
      <ElementFade>
        <div
          className={clsx(
